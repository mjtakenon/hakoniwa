...
export const CELL_MODELS = {
  ...
  sea: {default: [{model: 'sea', opacity: 0.8, elevation_multiply: 0}, {model: 'floor'}]},
  shallow: {default: [{model: 'shallow', opacity: 0.8, elevation_multiply: 0}, {model: 'floor'}]},
  lake: {default: [{model: 'shallow', opacity: 0.8}, {model: 'floor', elevation_multiply: 0}]},
