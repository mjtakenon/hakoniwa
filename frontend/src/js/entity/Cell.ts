...
export const CELL_MODELS = {
  ...
  park: {default: [{model: 'plain'}, {model: 'monument'}]},
  monument_of_agriculture: {default: [{model: 'plain'}, {model: 'monument'}]},
  monument_of_mining: {default: [{model: 'plain'}, {model: 'monument'}]},
  monument_of_master: {default: [{model: 'plain'}, {model: 'monument'}]},
  monument_of_peace: {default: [{model: 'plain'}, {model: 'monument'}]},
  monument_of_war: {default: [{model: 'plain'}, {model: 'monument'}]},
  monument_of_conquest: {default: [{model: 'plain'}, {model: 'monument'}]},
