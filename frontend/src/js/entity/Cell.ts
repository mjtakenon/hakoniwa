...
export const CELL_PATHS = {
  city: { default: [{ path: '/img/hakoniwa/gltf/city.gltf' }] },
  factory: { default: [{ path: '/img/hakoniwa/gltf/factory.gltf' }] },
  ...
  metropolis: { default: [{ path: '/img/hakoniwa/gltf/metropolis.gltf' }] },
  ...
  oilfield: { default: [{ path: '/img/hakoniwa/gltf/oilfield.gltf' }, { path: '/img/hakoniwa/gltf/oilfield_transparent.gltf', opacity: 0.8}] },
  plain: { default: [{ path: '/img/hakoniwa/gltf/plain.gltf' }] },
  sea: { default: [{ path: '/img/hakoniwa/gltf/sea.gltf' }, { path: '/img/hakoniwa/gltf/sea_transparent.gltf', opacity: 0.8}] },
  shallow: { default: [{ path: '/img/hakoniwa/gltf/shallow.gltf' }, { path: '/img/hakoniwa/gltf/shallow_transparent.gltf', opacity: 0.8}] },
  lake: { default: [{ path: '/img/hakoniwa/gltf/shallow.gltf' }] },
  large_factory: { default: [{ path: '/img/hakoniwa/gltf/large_factory.gltf' }] },
  town: { default: [{ path: '/img/hakoniwa/gltf/town.gltf' }] },
  village: { default: [{ path: '/img/hakoniwa/gltf/village.gltf' }] },
  wasteland: { default: [{ path: '/img/hakoniwa/gltf/wasteland.gltf' }] },
  missile_base: { default: [{ path: '/img/hakoniwa/gltf/missile_base.gltf' }] },
  seabed_base: { default: [{ path: '/img/hakoniwa/gltf/plain.gltf' }] },
  park: { default: [{ path: '/img/hakoniwa/gltf/park.gltf' }] },
  monument_of_agriculture: { default: [{ path: '/img/hakoniwa/gltf/monument_of_agriculture.gltf' }] },
  monument_of_mining: { default: [{ path: '/img/hakoniwa/gltf/monument_of_mining.gltf' }] },
  monument_of_master: { default: [{ path: '/img/hakoniwa/gltf/monument_of_master.gltf' }] },
  monument_of_peace: { default: [{ path: '/img/hakoniwa/gltf/monument_of_peace.gltf' }] },
  monument_of_war: { default: [{ path: '/img/hakoniwa/gltf/monument_of_war.gltf' }] },
  monument_of_conquest: { default: [{ path: '/img/hakoniwa/gltf/monument_of_conquest.gltf' }] },
